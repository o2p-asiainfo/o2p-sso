...
<html>
<head>
	<title><s:text name="eaap.op2.sso.person.modifyPerson"/></title>
...
<!--	<script type="text/javascript" src="${contextPath}/resource/plugins/artDialog/iframeTools.js" ></script> -->
	...
	<script type="text/javascript">
	   ...
	   function formSubmit(){
			var sysPersonId = ${sysPersonMap.SYS_PERSON_ID};
			...
			if(!cardNumberReg.test(cardNumber)){
				...
				$.ajax({
					type: "post",
					url: "${contextPath}/sysPerson/isUpdatePersonExist.shtml",
					data: {
	   ...
	   <div class="contentWarp">
		  ...
		  <div class="module-path">
	  		  <div class="module-path-content">
		    	  ...
		    	  <img src="${contextPath}/resource/${contextStyleTheme}/images/module-path.png" /><s:text name="eaap.op2.sso.person.modifyPerson"/>
<!--		    	  <s:property value="%{getText('eaap.op2.conf.server.manager.choice')}" />-->
	      ...
	      <div>
	      	   <form name="myForm" id="myForm" method="post" action="${contextPath}/sysPerson/updateSysPerson.shtml?sysPersonId=${sysPersonMap.SYS_PERSON_ID}">
	 		   	<table class="mgr-table">
					<tr>
	  					<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.person.cardNumber"/>:</td>
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="cardNumber" id="cardNumber" value="${sysPersonMap.CARD_NUMBER}"></ui:inputText>
	  						</div>  	
	   					</td>
	   					<td class="item"><s:text name="eaap.op2.sso.person.personName"/>:</td>
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="name" id="name" value="${sysPersonMap.NAME}"></ui:inputText>
	  						</div>  	
	   					</td>
	   					<td class="item"><s:text name="eaap.op2.sso.person.mobile"/>:</td>
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="mobile" id="mobile" value="${sysPersonMap.MOBILE}"></ui:inputText>
	  						</div>  	
	   					</td>
	   				</tr>
	   				<tr>
	   					...
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="email" id="email" value="${sysPersonMap.EMAIL}"></ui:inputText>
	  						</div>  	
	   					</td>
			   			<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.person.identity"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="sysIdTypeName" id="sysIdTypeName" value="${sysPersonMap.SYS_ID_TYPE_ID}" list="sysIdTypeList"   headerValue=" "	 listKey="sysIdTypeId" listValue="sysIdTypeName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
			  			<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.person.userType"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="sysUserTypeName" id="sysUserTypeName" value="${sysPersonMap.SYS_USER_TYPE}" list="sysUserTypeList"   headerValue=" "	 listKey="sysUserTypeId" listValue="sysUserTypeName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
	   				</tr>
	   				<tr>
			   			...
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="sysCardTypeName" id="sysCardTypeName" value="${sysPersonMap.SYS_CARD_TYPE_ID}" list="sysCardTypeList"  emptyOption="true" headerValue=" "	 listKey="sysCardTypeId" listValue="sysCardTypeName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
	   					<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.person.department"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="sysDeptName" id="sysDeptName" value="${sysPersonMap.DEPT_ID}" list="deptList"  headerValue=" "	 listKey="deptId" listValue="sysDeptName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
			  			<td class="item"><s:text name="eaap.op2.sso.person.area"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="sysAreaName" id="sysAreaName" value="${sysPersonMap.SYS_AREA_ID}" list="sysAreaList"  emptyOption="true" headerValue=" "	 listKey="sysAreaId" listValue="sysAreaName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
	   				</tr>
	   				<tr>
			   			...
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="state" id="state" value="${sysPersonMap.SYS_STATUS_ID}" list="stateList"   headerValue=" "	 listKey="stateId" listValue="stateName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
			   			<td></td>
			   			<td></td>
