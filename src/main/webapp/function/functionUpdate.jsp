...
<html>
<head>
	<title><s:text name="eaap.op2.sso.function.modifyFunction"/></title>
...
<!--	<script type="text/javascript" src="${contextPath}/resource/plugins/artDialog/iframeTools.js" ></script> -->
	...
	<script type="text/javascript">
	   ...
	   function formSubmit(){
			...
			var functionId = ${SysFunction.functionId};
			...
			if(!functionNameReg.test(functionName)){
				...
				alert("<s:text name='eaap.op2.sso.function.showNumOverlong'/>");
			}else{
				$.ajax({
					type: "post",
					url: "${contextPath}/sysFunction/isUpdateFunctionExist.shtml",
					data: {
	   ...
	   <div class="contentWarp">
		  ...
		  <div class="module-path">
	  		  <div class="module-path-content">
		    	  ...
		    	  <img src="${contextPath}/resource/${contextStyleTheme}/images/module-path.png" /><s:text name="eaap.op2.sso.function.modifyFunction"/>
<!--		    	  <s:property value="%{getText('eaap.op2.conf.server.manager.choice')}" />-->
	      ...
	      <div>
	      	   <form name="myForm" id="myForm" method="post" action="${contextPath}/sysFunction/updateSysFunction.shtml?functionId=${SysFunction.functionId}">
	 		   	<table class="mgr-table">
					<tr>
						<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.function.functionName"/>:</td>
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="sysFunctionName" id="sysFunctionName"  value="${SysFunction.functionName}"></ui:inputText>
	  						</div>  	
	   					</td>
	   					<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.function.parentFunction"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="parentFunctionName" id="parentFunctionName" value="${SysFunction.parentFunctionId}" list="parentFunctionList"   headerValue=" "	 listKey="parentFunctionId" listValue="parentFunctionName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
			   			<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.function.sysBusiness"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="sysBusinessName" id="sysBusinessName" value="${SysFunction.businessSystemId}" list="sysBusinessList"   headerValue=" "	 listKey="sysBusinessId" listValue="sysBusinessName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
			   		</tr>
	  				<tr>
	  					<td class="item"><s:text name="eaap.op2.sso.function.url"/>:</td>
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="url" id="url" value="${SysFunction.url}"></ui:inputText>
	  						</div>  	
	   					</td>
	   					<td class="item"><s:text name="eaap.op2.sso.function.displayMode"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="displayMode" id="displayMode" value="${SysFunction.displayMode}" list="displayModeList"  emptyOption="true" headerValue=" "	 listKey="displayModeId" listValue="displayModeName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
			  			<td class="item"><font color="red">*</font><s:text name="eaap.op2.sso.function.status"/>:</td>
			   			<td class="item-content">
			   				<div class="ui-widget">
			  				    <ui:select skin="${contextStyleTheme}" name="state" id="state" value="${SysFunction.sysStatusId}" list="stateList"   headerValue=" "	 listKey="stateId" listValue="stateName" onchange="getChangeData(this.value);"></ui:select>
			  				</div>  	
			   			</td>
	   				</tr>
	   				<tr>
	   					<td class="item"><s:text name="eaap.op2.sso.function.shouNum"/>:</td>
	   					<td class="item-content">
	   						<div class="ui-widget">
	  							<ui:inputText skin="${contextStyleTheme}" name="shownum" id="shownum" value="${SysFunction.shownum}"></ui:inputText>
	  						</div>  	
	   					</td>
	   				</tr>
	    	    </table>
