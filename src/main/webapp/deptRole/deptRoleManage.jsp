...
<html>
<head>
	<title><s:text name="eaap.op2.sso.deptRole.deptRoleManage"/></title>
...
<!--	<script type="text/javascript" src="${contextPath}/resource/plugins/artDialog/iframeTools.js" ></script> -->
	...
	<script type="text/javascript">
        ...
        function addMehtod(){
        	window.location.href="${contextPath}/sysDeptRole/showAddSysDeptRole.shtml"; 
     	}
     	/**
      	...
      	function deleteMethod(){
        	var rows = $('#mygrid').datagrid('getSelections');
            if(rows.length==0){
	             alert("<s:text name='eaap.op2.sso.deptRole.selectNotNull'/>");
	             return false; 
            } 
       		var deptRoleId = rows[0].DEPT_ROLE_ID;
       		var t = window.confirm("<s:text name='eaap.op2.sso.deptRole.deleteRecord'/>");
       		if(t == true){
       			$.ajax({
		            type:"post",
		            async:false,
		            url:"${contextPath}/sysDeptRole/deleteSysDeptRole.shtml",
		            data:{deptRoleId:deptRoleId},
	   ...
	   <div class="contentWarp">
		  ...
		  <div class="module-path">
	  		  <div class="module-path-content">
		    	  ...
		    	  <img src="${contextPath}/resource/${contextStyleTheme}/images/module-path.png" /><s:text name="eaap.op2.sso.deptRole.deptRoleManage"/>
<!--		    	  <s:property value="%{getText('eaap.op2.conf.server.manager.choice')}" />-->
	      ...
	      <div>
	      	   <form name="myForm" id="myForm" method="post">
					...
					<tr>
			  			<td class="item"><s:text name="eaap.op2.sso.deptRole.dept"/>:</td>
	    ...
	    <script type="text/javascript">
		   var title = [];
		   title[0]='<s:text name="eaap.op2.sso.deptRole.dept"/>';
		   title[1]='<s:text name="eaap.op2.sso.deptRole.role"/>';
		   title[2]='部门编号';
		   title[3]='角色编号';
		   title[4]='部门角色编号';
        </script>
		<ui:gridEasy  id="mygrid"  columns="cols" iconCls="icon-save" sortName="code" skin="${contextStyleTheme}" pageInfo="true" singleSelect="true"  sortOrder="desc"
			fit="true" collapsible="false"   title="" striped="true" pageList="10" pagination="true" frozenColumns="true" rownumbers="true" toolbar="true" method="eaap-op2-sso-sysDeptRoleAction.showGrid">
			<ui:gridEasyColumn width="250" index="0" title="0" field="DEPT_NAME" hidden="false" align="center"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="250" index="1" title="1" field="SYS_ROLE_NAME" hidden="false" align="center"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="250" index="2" title="2" field="DEPT_ID" hidden="true" align="center"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="250" index="3" title="3" field="SYS_ROLE_ID" hidden="true" align="center"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="250" index="4" title="4" field="DEPT_ROLE_ID" hidden="true" align="center"></ui:gridEasyColumn>
		</ui:gridEasy>
