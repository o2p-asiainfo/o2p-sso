...
<html>
<head>
	<title><s:text name="eaap.op2.sso.role.addNewRole"/></title>
	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			if(sysRoleNameReg.test(sysRoleName)){
				$.ajax({
					type: "post",
					url: "${contextPath}/sysRole/isRoleExist.shtml",
					data: {sysRoleName : sysRoleName},
					dataType: "json",
	   ...
	   <div class="contentWarp">
		  ...
		  <div class="module-path">
	  		  <div class="module-path-content">
		    	  ...
		    	  <img src="${contextPath}/resource/${contextStyleTheme}/images/module-path.png" /><s:text name="eaap.op2.sso.role.addNewRole"/>
<!--		    	  <s:property value="%{getText('eaap.op2.conf.server.manager.choice')}" />-->
	      ...
	      <div>
	      	   <form name="myForm" id="myForm" method="post" action="${contextPath}/sysRole/addSysRole.shtml">
