...
var App = function() {
    ...
    var handleAjaxMask = function() {
            $(document).ajaxStart(function() {
                App.showAjaxStartMask();
            }).ajaxStop(function() {
                $.unblockUI();
            });
        }     
    ...
    var handleCheckBox = function() {
            $('.group-check .group-checkable,#group-check .group-checkable').change(function() {
    ...
    return {              
        ...
        init: function() {
            ...
            setTimeout(handleUniform, 1); // fix 
        ...
        blockUI: function(options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img style="" src="'+contextPath+'/resource/new/img/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img style="" src="'+contextPath+'/resource/new/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="'+contextPath+'/resource/new/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : 'Loading...') + '</span></div>');
        },
        ...
        alert: function(options) {
            options = $.extend(true, {
                ...
                place: "append",
                // append or prepent in container 
                type: 'success',
                // alert's type
                message: "",
                // alert's message
        ...
        showAjaxErrorMask: function() {            
           
        },
        showAjaxStartMask: function() {
            $.blockUI({
                message: '<img src="..//'+contextPath+'/resource/new/img/loading-circle.gif" /> ',
                css: {
        ...
        paramArr1: ['billing', 'crm', 'bi', 'c3', 'o2p', 'upc'],
        paramArr2: ['host', 'interface', 'application'], //host.shtml
        paramArr3: ['os', 'mysql', 'tomcat', 'apache', 'dial', 'log', 'memcache', 'redis', 'ftp'], //os.shtml,mysql.shtml       
        paramArr4: ['service', 'call'], //
        paramArr5: ['system', 'kpi'], //
